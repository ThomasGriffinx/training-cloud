 ...
 <nav>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <h1 class="header center white-text bold">Training Cloud</h1>
    ...
    <div class="section">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Tutorials</h5>
            <p class="light">Learn a new concept and test your knowledge with our interactive coding demos</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Cloud</h5>

            <p class="light">Cloud technologies allow for user analytics like never before </p>
          </div>
        </div>
      </div>
  ...
  <div id="index-banner" class="parallax-container">
    ...
    <div class="container">
        <h2 class="header text_b">Courses</h2>
        <div class="row">
